...
public class FloorGamePieceTargeting extends SubsystemBase {
  ...
  public FloorGamePieceTargeting(double limelightOffset_X, double limelightOffset_Y) {
    m_gamepiececamera = new Limelight("conepy");

    System.out.println("Floor Limelight online??"); // Hopefully
  ...
  private void initializeShuffleboard() {
    ...
    ShuffleboardTab Tab = Shuffleboard.getTab("Floor GamePeiceTargeting");
