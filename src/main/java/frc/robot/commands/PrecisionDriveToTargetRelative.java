...
public class PrecisionDriveToTargetRelative extends CommandBase {
  ...
  public PrecisionDriveToTargetRelative(Pose2d data)// double MaxSpeed,
  ...
  public void initialize() {
    ...
    //GamePieceData data = RobotContainer.gamepiecetargeting.getTargetPose(); // Do it better??
    Pose2d odometryPose = RobotContainer.swerveodometry.getPose2d();
    Pose2d pose = new Pose2d(m_targetData.getX() + odometryPose.getX(), m_targetData.getY() + odometryPose.getY(), m_targetData.getRotation());
