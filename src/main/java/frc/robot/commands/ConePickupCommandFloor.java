...
// public class ConePickupCommandFloor extends CommandBase {
...
//   public ConePickupCommandFloor()// double MaxSpeed,
...
//     GamePieceData data = RobotContainer.floorgamepiecetargeting.getTargetPose(); // Robot relative
//     Pose2d odometryPose = RobotContainer.swerveodometry.getPose2d(); // Field relative
//     boolean pieceValidThisFrame = RobotContainer.floorgamepiecetargeting.getGamePieceValid();
...
//     if (RobotContainer.floorgamepiecetargeting.isTarget())
//     {
//       return RobotContainer.floorgamepiecetargeting.getTargetPose();
//     }
