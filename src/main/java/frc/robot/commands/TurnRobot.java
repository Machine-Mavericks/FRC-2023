...
public class TurnRobot extends CommandBase {
  ...
  public void execute() 
  {
    ...
    // rotate robot
    //double dx, double dy, double omega, boolean fieldOriented, boolean Park
    // where to use m_rotatespeed
    RobotContainer.swervedrive.drive(
      0.0, 0.0, -m_rotatespeed * SwerveDrive.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND, true, false); // field oriented true ?
  }
  ...
  public void end(boolean interrupted) {
    // stop robot
    RobotContainer.swervedrive.drive(0.0, 0.0, 0.0, true, false);
  }
