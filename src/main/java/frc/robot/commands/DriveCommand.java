...
public class DriveCommand extends CommandBase {
  ...
  public DriveCommand(SwerveDrive swerveDrive) {
  ...
  public void execute() {
    ...
    m_SwerveDrive.drive(new Translation2d(-yInput*SwerveDrive.MAX_VELOCITY_METERS_PER_SECOND, xInput*SwerveDrive.MAX_VELOCITY_METERS_PER_SECOND), rotInput*Drivetrain.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND, true); 
  }
