...
package frc.robot.commands.Autonomous.autonomous;
...
public class TurnToHubCommand extends CommandBase {
  ...
  */
  ...
  public void execute() {
    ...
    Pose2d pose = SwerveOdometry.getPose2d(); // get position
    ...
    RobotContainer.swervedrive.drive(new Translation2d(0,0), turnSpeed*SwerveDrive.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND, false); 
  }
  ...
  public boolean isFinished() {
    ...
    return ((RobotContainer.aprilTagTargeting.isTargetPresent() &&(Math.abs(RobotContainer.aprilTagTargeting.getTargetAngle()) <4.0))
